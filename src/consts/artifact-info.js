...
exports.artifactGroups = exports.translatedArtifactInfo = void 0;
const EN_json_1 = __importDefault(require("./textmaps/EN.json"));
const artifactInfo = [
    {
        "id": 10001,
...
exports.default = artifactInfo;
const translatedArtifactInfo = () => {
    const t = EN_json_1.default;
    return artifactInfo.map(artifact => {
        ...
        return {
            ...
            pieces: Object.fromEntries(Object.keys(pieces).map(key => {
                const { nameHash, descHash } = pieces[key];
                return [key, {
                        name: t[nameHash],
                        desc: t[descHash]
                    }];
            ...
            setBonuses: Object.fromEntries(Object.keys(setBonuses).map(key => {
                const { descHash } = setBonuses[parseInt(key)];
                return [
                    parseInt(key), {
                        desc: t[descHash]
                    }
...
exports.translatedArtifactInfo = translatedArtifactInfo;
exports.artifactGroups = [
    ...
    { nameId: "20-er", name: "20% ER", sets: ["emblem_of_severed_fate", "scholar", "the_exile"] },
