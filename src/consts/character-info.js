...
exports.translatedCharacterInfo = void 0;
...
const translatedCharacterInfo = () => {
    ...
    return characterInfo.map((info) => {
        ...
        return {
            ...
            title: t[titleHash],
            detail: t[detailHash],
            constellation: t[constellationHash],
            constellations: constellations.map(({ nameHash, descHash }) => ({
                name: t[nameHash],
                desc: t[descHash],
            })),
            energySkill: {
                name: t[energySkill.nameHash],
                desc: t[energySkill.descHash],
            },
...
exports.translatedCharacterInfo = translatedCharacterInfo;
/*
 type AvatarData = {
  id: number;
  nameId: string;
